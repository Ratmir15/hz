...
def initp():
    mpt  = MedicalProcedureType(name = 'Грязь на область', order = 1, duration = 30, start_time=datetime.time(8), finish_time = datetime.time(16), capacity = 2, optional='Живот,Голова,Нога,Задница')
    mpt.save()
    mpt1  = MedicalProcedureType(name = 'Подводное вытяжение в минеральной воде', order = 2, duration = 15, start_time=datetime.time(8), finish_time = datetime.time(17), capacity = 2)
    mpt1.save()
    ...
    mpt.save()
    mpt  = MedicalProcedureType(name = '4-х камерная ванна', order = 6, duration = 15, start_time=datetime.time(8), finish_time = datetime.time(17), capacity = 2, optional = "гальваническая, пневмо и гидро массажа")
    mpt.save()
    ...
    mpt.save()
    mpt  = MedicalProcedureType(name = 'Массаж ручной', order = 8, duration = 15, start_time=datetime.time(8), finish_time = datetime.time(17), capacity = 2, optional="спины,ШВЗ,пояснично-кресцовой,грудной области,ног,рук,головы")
    mpt.save()
    ...
    mpt.save()
    mpt  = MedicalProcedureType(name = 'Механомассаж', order = 17, duration = 15, start_time=datetime.time(8), finish_time = datetime.time(17), capacity = 2,optional="Ормед,анатомотор,Терамакс")
    mpt.save()
    mpt  = MedicalProcedureType(name = 'Физиопроцедура на область', order = 18, duration = 15, start_time=datetime.time(8), finish_time = datetime.time(17), capacity = 2, optional="СМТ,ДДТ,дарсонваль,магнит")
    mpt.save()
    mpt  = MedicalProcedureType(name = 'Физиопроцедура на область', order = 19, duration = 15, start_time=datetime.time(8), finish_time = datetime.time(17), capacity = 2, optional="УВЧ,э/форез,э/стимуляция,у/звук,КВЧ,трансаир,э/сон")
    mpt.save()
