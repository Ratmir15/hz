...
urlpatterns = patterns('',
    ...
    (r'^books/(?P<instance_id>\d+)/bill$', 'pansionat.views.book_bill'),
    ...
    (r'^mp/(?P<order_id>\d+)/$', 'pansionat.views.medical_procedures_v2'),
    (r'^mp2/(?P<order_id>\d+)/$', 'pansionat.views.medical_procedures_v2'),
    (r'^mp/(?P<order_id>\d+)/print/$', 'pansionat.views.medical_procedures_print'),
    (r'^mp/(?P<order_id>\d+)/print2/$', 'pansionat.views.medical_procedures_print2'),
#    (r'^mp/print/(?P<mp_type_id>\d+)/(?P<year>\d+)\.(?P<month>\d+)\.(?P<day>\d+)/$', 'pansionat.views.schedule_print'),
    ...
    (r'^mp2/save/$', 'pansionat.views.mp_save2'),
    ...
    (r'^lastlog/$', 'pansionat.alog.lastlog'),
    (r'^log/(?P<year>\d+)-(?P<month>\d+)-(?P<day>\d+)/$', 'pansionat.alog.lastlog_day'),
    ...
    (r'^orders/rko/(?P<occupied_id>\d+)/$', 'pansionat.views.rko'),
    ...
    (r'^order/(?P<order_id>\d+)/docs/$', 'pansionat.documents.docs'),
    (r'^order/(?P<order_id>\d+)/docs/(?P<doc_id>\d+)/$', 'pansionat.documents.open_doc'),
    (r'^docs/(?P<doc_id>\d+)/done/$', 'pansionat.documents.done_doc'),
    (r'^docs/(?P<doc_id>\d+)/cancel/$', 'pansionat.documents.cancel_doc'),
    (r'^docs/(?P<doc_id>\d+)/print/$', 'pansionat.documents.print_doc'),
    (r'^order/(?P<order_id>\d+)/docs/new_nakl/$', 'pansionat.documents.new_nakl'),
    (r'^order/(?P<order_id>\d+)/docs/new_sf/$', 'pansionat.documents.new_sf'),
    (r'^order/(?P<order_id>\d+)/docs/new_p/$', 'pansionat.documents.new_p'),
    (r'^order/(?P<order_id>\d+)/docs/new_r/$', 'pansionat.documents.new_r'),
    (r'^docs/(?P<doc_id>\d+)/save/$', 'pansionat.documents.docs_save'),
    (r'^order/json/(?P<order_id>\d+)/$', 'pansionat.orders.order_json'),
    (r'^order/save/$', 'pansionat.orders.order_save'),
    (r'^order/move/(?P<order_id>\d+)/(?P<room_id>\d+)/$', 'pansionat.orders.order_move'),
    ...
    (r'^rmkassa/$', 'pansionat.documents.rmkassa'),
    (r'^rmkassa/done/$', 'pansionat.documents.rmkassadone'),
    (r'^rmkassa/canceled/$', 'pansionat.documents.rmkassacanceled'),
